Shader "FlatLighting/Baked/baseSurfaceWithInstancing" {
	Properties {
	...
	SubShader {
		Tags { "RenderType"="Opaque" 
			   "FlatLightingBakedTag"="FL_COLORS_LOCAL;FL_SYMETRIC_COLORS_ON;FL_GRADIENT_AXIS_ON_X;FL_GRADIENT_AXIS_ON_Y;FL_GRADIENT_AXIS_ON_Z"
		...
		#pragma multi_compile_instancing
			...
			#define FL_GRADIENT_AXIS_ON_X
			#define FL_GRADIENT_AXIS_ON_Y
			#define FL_GRADIENT_AXIS_ON_Z
