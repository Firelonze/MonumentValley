...
namespace FlatLighting {
	public static class Labels  {
        ...
        public static GUIContent UseGPUInstancing = new GUIContent("Use GPU Instancing", "Use GPU Instancing to avoid creating diffeerent materials for slightly changed properties.");
		...
		public static GUIContent UseCameraFog = new GUIContent("Camera based Fog");
		public static string FogColor = "Color";
		public static string FogBlendingWidth = "Blending Width";
		public static string FogCameraOffset = "Camera Offset";
		...
		public static GUIContent UnityShadow = new GUIContent("Unity Shadow", "Unity Shadow settings.");
