...
public class Player : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (moving == true)
        {
            if (Vector3.Distance(currentWaypointVector, this.transform.position) < 0.01)
            {
                if (walkIndex == 10 && destinationInt >= 13 && pathRefresher.GetComponent<Path>().array6Aan == true)
                {
                    walkIndex = 13;
                }
                else if (walkIndex == 11 && destinationInt >= 13 && pathRefresher.GetComponent<Path>().array6Aan == true || walkIndex == 12 && destinationInt >= 13 && pathRefresher.GetComponent<Path>().array6Aan == true)
                {
                    walkIndex--;
                }
                else if (omhoog == true)
                ...
                if (walkIndex == 13 && destinationInt <= 13 && pathRefresher.GetComponent<Path>().array6Aan == true)
                {
                    walkIndex = 10;
                }
            ...
            if (currentWaypoint == 13 && pathRefresher.GetComponent<Path>().array3Aan == true || currentWaypoint == 14 && pathRefresher.GetComponent<Path>().array3Aan == true)
            {
    ...
    public void GetNextWaypoint()
    {
        ...
        currentWaypointVector = new Vector3(currentWaypointObject.transform.position.x, currentWaypointObject.transform.position.y + 0.776f, currentWaypointObject.transform.position.z);
    }
}
